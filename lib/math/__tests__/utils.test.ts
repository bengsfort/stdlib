...
describe('Math Utilities', () => {
  ...
  describe('transformRange', () => {
    it('should transform a value from one range to another', () => {
      expect(transformRange(5, 0, 10, 0, 100)).toEqual(50);
      expect(transformRange(15, 10, 20, 0, 100)).toEqual(50);
      expect(transformRange(50, 0, 100, 0, 10)).toEqual(5);
      expect(transformRange(15, 10, 20, 0, 1)).toEqual(0.5);
    });
  });
